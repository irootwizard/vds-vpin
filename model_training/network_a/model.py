"""PyTorch Network A — topology aligned with AHE homomorphic inference."""
...
from model_training.network_a.truncation_config import DEFAULT_PLAN, FIXED_POINT_BITS, TruncationPlan
...
class NetworkA(nn.Module):
    ...
    def _run_fixed_point(
        ...
        *,
        ...
        if return_bounds:
            return after_fc2.to(orig_device), bounds
        return after_fc2.to(orig_device)
