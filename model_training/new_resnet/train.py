"""Train ResNet18 (CIFAR-adapted) on CIFAR-10."""
...
def train(
    *,
    ...
    out_dir = (output_root or REPO / "model_training" / "outputs") / f"resnet18_{run_id}"
    ...
    best_acc = 0.0
    metrics = {"run_id": run_id, "model": "ResNet18_CIFAR", "input_size": 32, "epochs": []}
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="Train ResNet18 on CIFAR-10")
