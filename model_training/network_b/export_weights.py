"""Export Network B FC weights to npy for AHE inference."""
...
from model_training.network_b.truncation_config import TruncationPlan
...
def export_weights(run_dir: Path) -> None:
    ...
    np.save(run_dir / "weight_fc1_64_32.npy", w1)
    np.save(run_dir / "bias_fc1_32.npy", b1)
    np.save(run_dir / "weight_fc2_32_10.npy", w2)
